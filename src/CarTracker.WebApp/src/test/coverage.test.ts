...
const EXEMPT: Record<string, string> = {
  ...
  TableControls: 'has its own TableControls.test with an axe sweep; rendered by six log screens, whose .test files sweep the page with the strip on it',
  ...
  DeploymentPanel: 'rendered by AdminPage; AdminPage.test sweeps the page with it loaded',
  AccountsPanel: 'ditto - rendered by AdminPage, swept with the page',
  PosturePanel: 'ditto - rendered by AdminPage, swept with the page',
  AccountSheet: 'ditto - opened from AdminPage, swept with the page and the sheet open',
  ...
  GroupsSheet: 'rendered by BudgetPage; phase3.test sweeps the page',
  BudgetBars: 'rendered by BudgetPage (phase3.test) and the dashboard SpendPanel — both axe-swept',
