...
> Created: 2026-08-09
> Status: **Complete.** Shipped 2026-08-09 in `f4a677b` (0.10.0), then **rewritten in 0.11.0** - the first cut was assembled
...
>
> Tasks 6.4 and 6.5 trailed the rest, both needing a deployed build (Auth0's registration form actually being
> reached by `screen_hint`, and a 360px wrap check); both were verified there and the spec closed 2026-08-17.
